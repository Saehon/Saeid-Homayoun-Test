...
Network calls require SEC fair-access User-Agent and internet connectivity.
...
def fetch_tables(url: str):
    # pandas.read_html performs the actual table ingestion.
    # For production use, wrap HTTP access with an SEC-compliant User-Agent/session.
